...
public class EspaciosRecreativos extends JFrame {
    ...
    private Vector<Empleado> listaEmpleados = new Vector<>();
    private static Vector<Reserva> listaReservas = new Vector<>(); // lista estática y compartida
    ...
    public static Vector<Reserva> getListaReservas() {
